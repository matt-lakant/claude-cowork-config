...
1. `_assets/candidate_profile.md` — for leverage framing
2. The offer details (Matt provides)
3. Optional: market comp data from public sources (Levels.fyi, BLS, recent role-specific surveys)
...
**Verbal script:** for the follow-up call, a 60-second opening + bullet talking points. Save: `applications/<company>-<role>/negotiation/verbal_script.md`
...
Computer:// links to the email + verbal script + playbook. Plus a 5-line summary in chat of the strategy.
...
- **He's the cost of multiple processes:** treat this like a competitive sales close — sequence, deadlines, who's in the lead.
